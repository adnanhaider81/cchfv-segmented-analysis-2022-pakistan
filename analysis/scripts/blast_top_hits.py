...
ap.add_argument('--max_hits', type=int, default=25)
a = ap.parse_args()
cmd = ['blastn', '-query', a.contigs, '-outfmt', '6 qseqid sacc pident length evalue bitscore staxids sscinames sseqid sskingdoms scomnames stitle']
...
with open(a.out_tsv, 'w') as out:
    out.write('contig\tacc\tpident\tlength\tevalue\tbitscore\ttaxid\tsciname\tsseqid\tskingdom\tscomname\tstitle\n')
